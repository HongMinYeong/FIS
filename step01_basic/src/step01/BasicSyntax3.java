...
//			>> non-static 변수들은 객체 생성시 메모리에 생성  
	...
	public static void main(String[] args) {
		...
		BasicSyntax3.info(); // 외부에서 static메소드 호출하는 문법
...
//		API설계자 자체도 사용자들이 주는 값 받고 비교하고 반환하고
...
//			-? / 문자열과 한글자 위치 / 하나의 char 값 반환
//					
//		3. 이미 존재하는 문자열에 새로운 문자열 받아서 결합해서 반환
//			- ? / 문자열과 새로 받는 데이터 (String) /문자열 하나 반환
