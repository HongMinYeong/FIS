...
//		- 메소드 구현시에 객체 생성없이 호출 가능란 방법
//			: static 키워드
//			:static로 구성된 메소드를 다수 보유한 API 활용
...
public class BasicSyntax1 {
	...
	//실행을 위한 특별 메소드 
	// >java BasicSynstax1 실행시 main 메소드 자동 실행 
	// main 호출은 jre 
	public static void main(String[] args) {
		//TODO 문자열 저장 
		// 문자열 : String / 32 bit 정수 : int
/*
 * 	String nephew = "시아";
		실행시 실행 순서
		String
...
*/	 
		...
		System.out.println(nephew + "의 나이는 "+ age + "살 이다.");
